...
4. Follow the [Destrier contributor guide](https://docs.destrier.io/contributing/box-structure) to configure, validate, and submit it.
...
For box structure, runtime flags, validation, submission, and the full contribution workflow, see the [Destrier contributor documentation](https://docs.destrier.io/contributing/overview) .